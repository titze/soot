    ...
    public jedd.internal.RelationContainer next() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new jedd.Attribute[] {  },
                                              ...
                                              ("<> ret; at /home/olhotak/soot-resolving2/src/soot/util/queue" +
                                               "/BDDReader.jedd:41,11-14"));
        do  {
            ret.eq(chunk.bdd);
            chunk = chunk.next;
        ...
        return new jedd.internal.RelationContainer(new jedd.Attribute[] {  },
                                                   new jedd.PhysicalDomain[] {  },
                                                   ("return ret; at /home/olhotak/soot-resolving2/src/soot/util/q" +
                                                    "ueue/BDDReader.jedd:47,8-14"),
                                                   ret);
    }
