...
public class BDDPAG extends AbsPAG {
    ...
    public Iterator allocLookup(Context ctxt, AllocNode key) {
        return new ContextVarNodeIterator(new jedd.internal.RelationContainer(new Attribute[] { varc.v(), var.v() },
                                                                              ...
                                                                              ("new soot.jimple.paddle.BDDPAG.ContextVarNodeIterator(...) at" +
                                                                               ...
                                                                               "3,15-18"),
                                                                              jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(allocBDD,
                                                                                                                                                                        new PhysicalDomain[] { V1.v() },
                                                                                                                                                                        new PhysicalDomain[] { V2.v() })),
                                                                                                             jedd.internal.Jedd.v().literal(new Object[] { ctxt, key },
    ...
    public Rsrcc_src_dstc_dst allSimple() {
        return new Rsrcc_src_dstc_dstBDD(new jedd.internal.RelationContainer(new Attribute[] { dst.v(), srcc.v(), dstc.v(), src.v() },
                                                                             new PhysicalDomain[] { V2.v(), C1.v(), C2.v(), V1.v() },
    ...
    public Rsrcc_src_fld_dstc_dst allLoad() {
        return new Rsrcc_src_fld_dstc_dstBDD(new jedd.internal.RelationContainer(new Attribute[] { dst.v(), srcc.v(), dstc.v(), src.v(), fld.v() },
    ...
    public Robjc_obj_varc_var allAlloc() {
        return new Robjc_obj_varc_varBDD(new jedd.internal.RelationContainer(new Attribute[] { varc.v(), objc.v(), var.v(), obj.v() },
