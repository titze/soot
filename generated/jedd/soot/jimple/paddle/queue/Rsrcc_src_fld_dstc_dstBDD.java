...
public final class Rsrcc_src_fld_dstc_dstBDD extends Rsrcc_src_fld_dstc_dst {
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), fld.v(), dstc.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc:soot.jimple.padd" +
                                           ...
                                           "ome/olhotak/soot-ref2/src/soot/jimple/paddle/queue/Rsrcc_src" +
    ...
    public Rsrcc_src_fld_dstc_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), dstc.v(), srcc.v(), src.v() },
                                                     new PhysicalDomain[] { FD.v(), V2.v(), C2.v(), C1.v(), V1.v() },
                                                     ("this.add(bdd) at /home/olhotak/soot-ref2/src/soot/jimple/pad" +
                                                      "dle/queue/Rsrcc_src_fld_dstc_dstBDD.jedd:33,114-117"),
                                                     bdd));
    }
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), dstc.v(), srcc.v(), src.v() },
                                                          new PhysicalDomain[] { FD.v(), V2.v(), C2.v(), C1.v(), V1.v() },
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "ref2/src/soot/jimple/paddle/queue/Rsrcc_src_fld_dstc_dstBDD." +
                                                           "jedd:45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), fld.v(), dstc.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "me/olhotak/soot-ref2/src/soot/jimple/paddle/queue/Rsrcc_src_" +
                                               "fld_dstc_dstBDD.jedd:55,51-54"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), dstc.v(), srcc.v(), src.v() },
                                                   new PhysicalDomain[] { FD.v(), V2.v(), C2.v(), C1.v(), V1.v() },
