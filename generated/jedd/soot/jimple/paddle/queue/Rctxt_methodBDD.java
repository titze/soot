    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { ctxt.v(), method.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.ctxt:soot.jimple.padd" +
                                           ...
                                           "jimple.paddle.bdddomains.T1> bdd at /home/olhotak/soot-ref/s" +
                                           "rc/soot/jimple/paddle/queue/Rctxt_methodBDD.jedd:31,12-32"));
    ...
    public Rctxt_methodBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        this.add(new jedd.internal.RelationContainer(new Attribute[] { ctxt.v(), method.v() },
                                                     ...
                                                     ("this.add(bdd) at /home/olhotak/soot-ref/src/soot/jimple/padd" +
                                                      "le/queue/Rctxt_methodBDD.jedd:33,82-85"),
                                                     bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { ctxt.v(), method.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "ref/src/soot/jimple/paddle/queue/Rctxt_methodBDD.jedd:45,25-" +
                                                           "28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { ctxt.v(), method.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "addle.bdddomains.T1> ret = bdd; at /home/olhotak/soot-ref/sr" +
                                               "c/soot/jimple/paddle/queue/Rctxt_methodBDD.jedd:55,29-32"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
