...
public final class Rsrcc_src_dstc_dstBDD extends Rsrcc_src_dstc_dst {
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), dstc.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc:soot.jimple.padd" +
                                           ...
                                           "tak/soot-ref2/src/soot/jimple/paddle/queue/Rsrcc_src_dstc_ds" +
                                           "tBDD.jedd:31,12-46"));
    ...
    public Rsrcc_src_dstc_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { dst.v(), dstc.v(), srcc.v(), src.v() },
                                                     new PhysicalDomain[] { V2.v(), C2.v(), C1.v(), V1.v() },
                                                     ("this.add(bdd) at /home/olhotak/soot-ref2/src/soot/jimple/pad" +
                                                      "dle/queue/Rsrcc_src_dstc_dstBDD.jedd:33,102-105"),
                                                     bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { dst.v(), dstc.v(), srcc.v(), src.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "ref2/src/soot/jimple/paddle/queue/Rsrcc_src_dstc_dstBDD.jedd" +
                                                           ":45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), dstc.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ak/soot-ref2/src/soot/jimple/paddle/queue/Rsrcc_src_dstc_dst" +
                                               "BDD.jedd:55,43-46"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
