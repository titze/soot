    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc:soot.jimple.padd" +
                                           ...
                                           "2> bdd at /home/olhotak/soot-resolving2/src/soot/jimple/padd" +
                                           "le/queue/Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD.jedd:31,12-66"));
    
    void add(final jedd.internal.RelationContainer tuple) { bdd.eqUnion(tuple); }
    
    public Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), stmt.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                     new PhysicalDomain[] { T2.v(), ST.v(), FD.v(), T1.v(), V1.v(), V2.v() },
                                                     ("this.add(bdd) at /home/olhotak/soot-resolving2/src/soot/jimp" +
                                                      "le/paddle/queue/Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD.jedd:33,13" +
                                                      "4-137"),
                                                     bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), stmt.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "resolving2/src/soot/jimple/paddle/queue/Rsrcc_srcm_stmt_kind" +
                                                           "_tgtc_tgtmBDD.jedd:45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               " bdd; at /home/olhotak/soot-resolving2/src/soot/jimple/paddl" +
                                               "e/queue/Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD.jedd:55,63-66"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), stmt.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                   new PhysicalDomain[] { T2.v(), ST.v(), FD.v(), T1.v(), V1.v(), V2.v() },
                                                   ("return ret; at /home/olhotak/soot-resolving2/src/soot/jimple" +
                                                    "/paddle/queue/Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD.jedd:57,8-14"),
                                                   ret);
    }
