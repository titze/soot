...
public final class Qvarc_var_objc_objBDD extends Qvarc_var_objc_obj {
    ...
    public void add(Context _varc, VarNode _var, Context _objc, AllocNode _obj) {
        this.add(new jedd.internal.RelationContainer(new Attribute[] { varc.v(), var.v(), objc.v(), obj.v() },
                                                     ...
                                                     ("this.add(jedd.internal.Jedd.v().literal(new java.lang.Object" +
                                                      ...
                                                      "ueue/Qvarc_var_objc_objBDD.jedd:34,8-11"),
    ...
    public void add(final jedd.internal.RelationContainer in) {
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { varc.v(), obj.v(), objc.v(), var.v() },
                                                           new PhysicalDomain[] { C1.v(), H1.v(), C2.v(), V1.v() },
                                                           ("reader.add(in) at /home/olhotak/soot-resolving2/src/soot/jim" +
                                                            "ple/paddle/queue/Qvarc_var_objc_objBDD.jedd:39,12-18"),
                                                           in));
        }
    }
