...
public final class Qobjc_obj_varc_varBDD extends Qobjc_obj_varc_var {
    ...
    public void add(Context _objc, AllocNode _obj, Context _varc, VarNode _var) {
        this.add(new jedd.internal.RelationContainer(new Attribute[] { objc.v(), obj.v(), varc.v(), var.v() },
                                                     ...
                                                     ("this.add(jedd.internal.Jedd.v().literal(new java.lang.Object" +
                                                      ...
                                                      "bjc_obj_varc_varBDD.jedd:34,8-11"),
    ...
    public void add(final jedd.internal.RelationContainer in) {
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { varc.v(), objc.v(), var.v(), obj.v() },
                                                           new PhysicalDomain[] { C1.v(), C2.v(), V1.v(), H1.v() },
                                                           ("reader.add(in) at /home/olhotak/soot-ref/src/soot/jimple/pad" +
                                                            "dle/queue/Qobjc_obj_varc_varBDD.jedd:39,12-18"),
                                                           in));
        }
    }
