    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { var.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.var:soot.jimple.paddl" +
                                           "e.bdddomains.V1> bdd at /home/olhotak/soot-resolving2/src/so" +
                                           "ot/jimple/paddle/queue/RvarBDD.jedd:31,12-20"));
    ...
    public RvarBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        this.add(new jedd.internal.RelationContainer(new Attribute[] { var.v() },
                                                     ...
                                                     ("this.add(bdd) at /home/olhotak/soot-resolving2/src/soot/jimp" +
                                                      "le/paddle/queue/RvarBDD.jedd:33,62-65"),
                                                     bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { var.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "resolving2/src/soot/jimple/paddle/queue/RvarBDD.jedd:45,25-2" +
                                                           "8"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.var:soot.jimple.paddle.bdddom" +
                                               "ains.V1> ret = bdd; at /home/olhotak/soot-resolving2/src/soo" +
                                               "t/jimple/paddle/queue/RvarBDD.jedd:55,17-20"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { var.v() },
                                                   new PhysicalDomain[] { V1.v() },
                                                   ("return ret; at /home/olhotak/soot-resolving2/src/soot/jimple" +
                                                    "/paddle/queue/RvarBDD.jedd:57,8-14"),
                                                   ret);
    }
