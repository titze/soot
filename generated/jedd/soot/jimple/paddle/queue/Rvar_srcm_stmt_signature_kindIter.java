    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), signature.v(), kind.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.var:soot.jimple.paddle.bdddom" +
                                               ...
                                               ".internal.Jedd.v().falseBDD(); at /home/olhotak/soot-ref2/sr" +
                                               "c/soot/jimple/paddle/queue/Rvar_srcm_stmt_signature_kindIter" +
                                               ".jedd:46,58-61"),
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { var.v(), kind.v(), srcm.v(), stmt.v(), signature.v() },
                                                   ...
                                                   ("return ret; at /home/olhotak/soot-ref2/src/soot/jimple/paddl" +
                                                    "e/queue/Rvar_srcm_stmt_signature_kindIter.jedd:50,8-14"),
                                                   ret);
    }
