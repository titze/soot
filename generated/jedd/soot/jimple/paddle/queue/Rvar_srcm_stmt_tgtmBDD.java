...
public final class Rvar_srcm_stmt_tgtmBDD extends Rvar_srcm_stmt_tgtm {
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), tgtm.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.var:soot.jimple.paddl" +
                                           ...
                                           "otak/soot-resolving2/src/soot/jimple/paddle/queue/Rvar_srcm_" +
                                           "stmt_tgtmBDD.jedd:31,12-47"));
    ...
    public Rvar_srcm_stmt_tgtmBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        this.add(new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), stmt.v(), srcm.v(), var.v() },
                                                     new PhysicalDomain[] { T2.v(), ST.v(), T1.v(), V1.v() },
                                                     ("this.add(bdd) at /home/olhotak/soot-resolving2/src/soot/jimp" +
                                                      "le/paddle/queue/Rvar_srcm_stmt_tgtmBDD.jedd:33,104-107"),
                                                     bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), stmt.v(), srcm.v(), var.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "resolving2/src/soot/jimple/paddle/queue/Rvar_srcm_stmt_tgtmB" +
                                                           "DD.jedd:45,25-28"),
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.var:soot.jimple.paddle.bdddom" +
                                               ...
                                               "tak/soot-resolving2/src/soot/jimple/paddle/queue/Rvar_srcm_s" +
                                               "tmt_tgtmBDD.jedd:55,44-47"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), stmt.v(), srcm.v(), var.v() },
                                                   ...
                                                   ("return ret; at /home/olhotak/soot-resolving2/src/soot/jimple" +
                                                    "/paddle/queue/Rvar_srcm_stmt_tgtmBDD.jedd:57,8-14"),
                                                   ret);
    }
