    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { obj.v(), method.v(), type.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.obj:soot.jimple.paddl" +
                                           ...
                                           "ot-ref2/src/soot/jimple/paddle/queue/Robj_method_typeBDD.jed" +
                                           "d:31,12-40"));
    ...
    public Robj_method_typeBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        this.add(new jedd.internal.RelationContainer(new Attribute[] { method.v(), type.v(), obj.v() },
                                                     ...
                                                     ("this.add(bdd) at /home/olhotak/soot-ref2/src/soot/jimple/pad" +
                                                      "dle/queue/Robj_method_typeBDD.jedd:33,94-97"),
                                                     bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { method.v(), type.v(), obj.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "ref2/src/soot/jimple/paddle/queue/Robj_method_typeBDD.jedd:4" +
                                                           "5,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { obj.v(), method.v(), type.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.obj:soot.jimple.paddle.bdddom" +
                                               ...
                                               "t-ref2/src/soot/jimple/paddle/queue/Robj_method_typeBDD.jedd" +
                                               ":55,37-40"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
