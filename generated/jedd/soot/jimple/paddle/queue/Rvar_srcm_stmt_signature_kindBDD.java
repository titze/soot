    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), signature.v(), kind.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.var:soot.jimple.paddl" +
                                           ...
                                           "d at /home/olhotak/soot-ref/src/soot/jimple/paddle/queue/Rva" +
                                           "r_srcm_stmt_signature_kindBDD.jedd:31,12-61"));
    
    void add(final jedd.internal.RelationContainer tuple) { bdd.eqUnion(tuple); }
    
    public Rvar_srcm_stmt_signature_kindBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), srcm.v(), signature.v(), var.v(), kind.v() },
                                                     new PhysicalDomain[] { ST.v(), T1.v(), H2.v(), V1.v(), FD.v() },
                                                     ("this.add(bdd) at /home/olhotak/soot-ref/src/soot/jimple/padd" +
                                                      "le/queue/Rvar_srcm_stmt_signature_kindBDD.jedd:33,128-131"),
                                                     bdd));
    }
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), srcm.v(), signature.v(), var.v(), kind.v() },
                                                          new PhysicalDomain[] { ST.v(), T1.v(), H2.v(), V1.v(), FD.v() },
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "ref/src/soot/jimple/paddle/queue/Rvar_srcm_stmt_signature_ki" +
                                                           "ndBDD.jedd:45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), signature.v(), kind.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.var:soot.jimple.paddle.bdddom" +
                                               ...
                                               " at /home/olhotak/soot-ref/src/soot/jimple/paddle/queue/Rvar" +
                                               "_srcm_stmt_signature_kindBDD.jedd:55,58-61"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), srcm.v(), signature.v(), var.v(), kind.v() },
                                                   new PhysicalDomain[] { ST.v(), T1.v(), H2.v(), V1.v(), FD.v() },
