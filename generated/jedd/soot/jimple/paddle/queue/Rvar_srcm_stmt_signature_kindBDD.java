    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), signature.v(), kind.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.var:soot.jimple.paddl" +
                                           ...
                                           "d at /home/olhotak/soot-ref2/src/soot/jimple/paddle/queue/Rv" +
                                           "ar_srcm_stmt_signature_kindBDD.jedd:31,12-61"));
    
    void add(final jedd.internal.RelationContainer tuple) { bdd.eqUnion(tuple); }
    
    public Rvar_srcm_stmt_signature_kindBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { var.v(), kind.v(), srcm.v(), stmt.v(), signature.v() },
                                                     new PhysicalDomain[] { V1.v(), FD.v(), T1.v(), ST.v(), H2.v() },
                                                     ("this.add(bdd) at /home/olhotak/soot-ref2/src/soot/jimple/pad" +
                                                      "dle/queue/Rvar_srcm_stmt_signature_kindBDD.jedd:33,128-131"),
                                                     bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { var.v(), kind.v(), srcm.v(), stmt.v(), signature.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "ref2/src/soot/jimple/paddle/queue/Rvar_srcm_stmt_signature_k" +
                                                           "indBDD.jedd:45,25-28"),
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), signature.v(), kind.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.var:soot.jimple.paddle.bdddom" +
                                               ...
                                               " at /home/olhotak/soot-ref2/src/soot/jimple/paddle/queue/Rva" +
                                               "r_srcm_stmt_signature_kindBDD.jedd:55,58-61"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { var.v(), kind.v(), srcm.v(), stmt.v(), signature.v() },
                                                   ...
                                                   ("return ret; at /home/olhotak/soot-ref2/src/soot/jimple/paddl" +
                                                    "e/queue/Rvar_srcm_stmt_signature_kindBDD.jedd:57,8-14"),
                                                   ret);
    }
