...
public final class Rvar_srcm_stmt_signature_kindBDD extends Rvar_srcm_stmt_signature_kind {
    ...
    public Rvar_srcm_stmt_signature_kindBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { srcm.v(), signature.v(), kind.v(), var.v(), stmt.v() },
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { srcm.v(), signature.v(), kind.v(), var.v(), stmt.v() },
                                                          new PhysicalDomain[] { T1.v(), H2.v(), FD.v(), V1.v(), ST.v() },
