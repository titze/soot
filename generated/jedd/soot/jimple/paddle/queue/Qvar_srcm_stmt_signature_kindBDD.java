...
public final class Qvar_srcm_stmt_signature_kindBDD extends Qvar_srcm_stmt_signature_kind {
    ...
    public void add(VarNode _var, SootMethod _srcm, Unit _stmt, NumberedString _signature, Kind _kind) {
        this.add(new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), signature.v(), kind.v() },
                                                     ...
                                                     ("this.add(jedd.internal.Jedd.v().literal(new java.lang.Object" +
                                                      ...
                                                      "ar_srcm_stmt_signature_kindBDD.jedd:34,8-11"),
    ...
    public void add(final jedd.internal.RelationContainer in) {
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), srcm.v(), signature.v(), var.v(), kind.v() },
                                                           new PhysicalDomain[] { ST.v(), T1.v(), H2.v(), V1.v(), FD.v() },
                                                           ("reader.add(in) at /home/olhotak/soot-ref/src/soot/jimple/pad" +
                                                            "dle/queue/Qvar_srcm_stmt_signature_kindBDD.jedd:39,12-18"),
                                                           in));
        }
    }
