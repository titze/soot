...
public final class Qctxt_var_obj_srcm_stmt_kind_tgtmBDD extends Qctxt_var_obj_srcm_stmt_kind_tgtm {
    ...
    public void add(Context _ctxt,
        ...
        this.add(new jedd.internal.RelationContainer(new Attribute[] { ctxt.v(), var.v(), obj.v(), srcm.v(), stmt.v(), kind.v(), tgtm.v() },
                                                     ...
                                                     ("this.add(jedd.internal.Jedd.v().literal(new java.lang.Object" +
                                                      ...
                                                      ")) at /home/olhotak/soot-resolving2/src/soot/jimple/paddle/q" +
                                                      "ueue/Qctxt_var_obj_srcm_stmt_kind_tgtmBDD.jedd:34,8-11"),
    ...
    public void add(final jedd.internal.RelationContainer in) {
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), stmt.v(), ctxt.v(), kind.v(), srcm.v(), obj.v(), var.v() },
                                                           new PhysicalDomain[] { T2.v(), ST.v(), V2.v(), FD.v(), T1.v(), H1.v(), V1.v() },
                                                           ("reader.add(in) at /home/olhotak/soot-resolving2/src/soot/jim" +
                                                            "ple/paddle/queue/Qctxt_var_obj_srcm_stmt_kind_tgtmBDD.jedd:3" +
                                                            "9,12-18"),
                                                           in));
        }
    }
