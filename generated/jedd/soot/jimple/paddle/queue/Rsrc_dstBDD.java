    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src:soot.jimple.paddl" +
                                           ...
                                           "le.paddle.bdddomains.V2> bdd at /home/olhotak/soot-resolving" +
                                           "2/src/soot/jimple/paddle/queue/Rsrc_dstBDD.jedd:31,12-28"));
    ...
    public Rsrc_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        this.add(new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                                     ...
                                                     ("this.add(bdd) at /home/olhotak/soot-resolving2/src/soot/jimp" +
                                                      "le/paddle/queue/Rsrc_dstBDD.jedd:33,74-77"),
                                                     bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "resolving2/src/soot/jimple/paddle/queue/Rsrc_dstBDD.jedd:45," +
                                                           "25-28"),
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               "e.bdddomains.V2> ret = bdd; at /home/olhotak/soot-resolving2" +
                                               "/src/soot/jimple/paddle/queue/Rsrc_dstBDD.jedd:55,25-28"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                                   ...
                                                   ("return ret; at /home/olhotak/soot-resolving2/src/soot/jimple" +
                                                    "/paddle/queue/Rsrc_dstBDD.jedd:57,8-14"),
                                                   ret);
    }
