...
public class BDDReachableMethods extends AbsReachableMethods {
    private final jedd.internal.RelationContainer reachables =
      new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.ctxt, soot.jimple.pad" +
                                           "dle.bdddomains.method> reachables at /home/olhotak/soot-reso" +
                                           "lving2/src/soot/jimple/paddle/BDDReachableMethods.jedd:30,12" +
                                           "-26"));
    ...
    boolean update() {
        ...
        if (methodsIn != null) {
            final jedd.internal.RelationContainer newMethodsIn =
              new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                                  ...
                                                  ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                                   ...
                                                   "e/olhotak/soot-resolving2/src/soot/jimple/paddle/BDDReachabl" +
                                                   "eMethods.jedd:42,27-39"),
                                                  methodsIn.get());
            ...
            out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                                        new jedd.PhysicalDomain[] { V1.v(), T1.v() },
                                                        ("out.add(newMethodsIn) at /home/olhotak/soot-resolving2/src/s" +
                                                         "oot/jimple/paddle/BDDReachableMethods.jedd:46,12-15"),
                                                        newMethodsIn));
        }
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               " at /home/olhotak/soot-resolving2/src/soot/jimple/paddle/BDD" +
                                               "ReachableMethods.jedd:49,45-53"),
        ...
        while (!jedd.internal.Jedd.v().equals(jedd.internal.Jedd.v().read(newEdges),
            ...
            final jedd.internal.RelationContainer newTargets =
              new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                                  ...
                                                  ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                                   ...
                                                   "addle.bdddomains.T1> newTargets = jedd.internal.Jedd.v().rep" +
                                                   ...
                                                   "jimple/paddle/BDDReachableMethods.jedd:55,27-37"),
                                                  jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().project(newEdges,
                                                                                                                new jedd.PhysicalDomain[] { ST.v(), FD.v(), T1.v(), V1.v() }),
            ...
            out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                                        ...
                                                        ("out.add(jedd.internal.Jedd.v().replace(newTargets, new jedd." +
                                                         ...
                                                         "/olhotak/soot-resolving2/src/soot/jimple/paddle/BDDReachable" +
                                                         "Methods.jedd:58,12-15"),
    ...
    boolean add(MethodOrMethodContext m) {
        final jedd.internal.RelationContainer newM =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "oot/jimple/paddle/BDDReachableMethods.jedd:66,23-27"),
        ...
        final jedd.internal.RelationContainer newReachables =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "me/olhotak/soot-resolving2/src/soot/jimple/paddle/BDDReachab" +
        ...
        if (!jedd.internal.Jedd.v().equals(jedd.internal.Jedd.v().read(newReachables), reachables)) {
            ...
            out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                                        new jedd.PhysicalDomain[] { V1.v(), T1.v() },
                                                        ("out.add(newM) at /home/olhotak/soot-resolving2/src/soot/jimp" +
                                                         "le/paddle/BDDReachableMethods.jedd:70,12-15"),
                                                        newM));
            return true;
        }
        return false;
    ...
    int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                                     new jedd.PhysicalDomain[] { V1.v(), T1.v() },
                                                     ("reachables.size() at /home/olhotak/soot-resolving2/src/soot/" +
                                                      "jimple/paddle/BDDReachableMethods.jedd:76,21-31"),
                                                     reachables).size();
    }
        ...
        final jedd.internal.RelationContainer newM =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ew java.lang.Object[...], new jedd.Attribute[...], new jedd." +
                                               "PhysicalDomain[...]); at /home/olhotak/soot-resolving2/src/s" +
                                               "oot/jimple/paddle/BDDReachableMethods.jedd:79,23-27"),
                                              jedd.internal.Jedd.v().literal(new Object[] { m.context(), m.method() },
                                                                             new jedd.Attribute[] { ctxt.v(), method.v() },
                                                                             new jedd.PhysicalDomain[] { V1.v(), T1.v() }));
