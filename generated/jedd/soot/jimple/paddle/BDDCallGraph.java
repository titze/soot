...
public class BDDCallGraph extends AbsCallGraph {
    private final jedd.internal.RelationContainer edges =
      new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc, soot.jimple.pad" +
                                           ...
                                           "olhotak/soot-ref2/src/soot/jimple/paddle/BDDCallGraph.jedd:3" +
                                           "0,12-48"));
        ...
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ges = in.get(); at /home/olhotak/soot-ref2/src/soot/jimple/p" +
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), srcm.v(), kind.v(), tgtc.v(), stmt.v(), srcc.v() },
                                                                                         new jedd.PhysicalDomain[] { T2.v(), T1.v(), FD.v(), V2.v(), ST.v(), V1.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/olhotak/soot-ref2/src/soot/jimple/paddle/BD" +
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edges() {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), kind.v(), srcm.v(), tgtc.v(), stmt.v(), srcc.v() },
                                                                                         new jedd.PhysicalDomain[] { T2.v(), FD.v(), T1.v(), V2.v(), ST.v(), V1.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/olhotak/soot-ref2/src/soot/jimple/paddle/BD" +
    ...
    public int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), kind.v(), srcm.v(), tgtc.v(), stmt.v(), srcc.v() },
                                                     new jedd.PhysicalDomain[] { T2.v(), FD.v(), T1.v(), V2.v(), ST.v(), V1.v() },
                                                     ("edges.size() at /home/olhotak/soot-ref2/src/soot/jimple/padd" +
