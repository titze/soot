...
public class BDDCallGraph extends AbsCallGraph {
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), stmt.v(), srcm.v(), tgtm.v(), tgtc.v(), kind.v() },
                                                                                         new jedd.PhysicalDomain[] { V1.v(), ST.v(), T1.v(), T2.v(), V2.v(), FD.v() },
    ...
    public int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), stmt.v(), srcm.v(), tgtm.v(), tgtc.v(), kind.v() },
                                                     new jedd.PhysicalDomain[] { V1.v(), ST.v(), T1.v(), T2.v(), V2.v(), FD.v() },
