...
public class BDDCallGraph extends AbsCallGraph {
    private final jedd.internal.RelationContainer edges =
      new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc, soot.jimple.pad" +
                                           ...
                                           "olhotak/soot-resolving2/src/soot/jimple/paddle/BDDCallGraph." +
                                           "jedd:30,12-48"));
    ...
    public boolean update() {
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ges = in.get(); at /home/olhotak/soot-resolving2/src/soot/ji" +
                                               "mple/paddle/BDDCallGraph.jedd:35,45-53"),
                                              in.get());
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), stmt.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                    ...
                                                    ("out.add(newEdges) at /home/olhotak/soot-resolving2/src/soot/" +
                                                     "jimple/paddle/BDDCallGraph.jedd:38,8-11"),
                                                    newEdges));
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { stmt.v(), tgtm.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                                                         new jedd.PhysicalDomain[] { ST.v(), T2.v(), FD.v(), T1.v(), V1.v(), V2.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/olhotak/soot-resolving2/src/soot/jimple/pad" +
                                                                                          "dle/BDDCallGraph.jedd:42,15-18"),
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(MethodOrMethodContext m) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { stmt.v(), tgtm.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                                                         ...
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/olhotak/soot-resolving2/src/soot/jimple/pad" +
                                                                                          "dle/BDDCallGraph.jedd:47,15-18"),
                                                                                         jedd.internal.Jedd.v().join(jedd.internal.Jedd.v().read(edges),
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edges() {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), stmt.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                                                         new jedd.PhysicalDomain[] { T2.v(), ST.v(), FD.v(), T1.v(), V1.v(), V2.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/olhotak/soot-resolving2/src/soot/jimple/pad" +
                                                                                          "dle/BDDCallGraph.jedd:54,15-18"),
                                                                                         edges),
                                                     "edges");
    }
    ...
    public int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), stmt.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                     new jedd.PhysicalDomain[] { T2.v(), ST.v(), FD.v(), T1.v(), V1.v(), V2.v() },
                                                     ("edges.size() at /home/olhotak/soot-resolving2/src/soot/jimpl" +
                                                      "e/paddle/BDDCallGraph.jedd:57,21-26"),
                                                     edges).size();
    }
}
