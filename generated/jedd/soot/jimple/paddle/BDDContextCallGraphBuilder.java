...
public class BDDContextCallGraphBuilder extends AbsContextCallGraphBuilder {
    ...
    private final jedd.internal.RelationContainer m2c =
      new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.ctxt, soot.jimple.pad" +
                                           ...
                                           "() at /home/olhotak/soot-resolving2/src/soot/jimple/paddle/B" +
                                           "DDContextCallGraphBuilder.jedd:36,12-26"),
    ...
    public boolean update() {
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ges = edgesIn.get(); at /home/olhotak/soot-resolving2/src/so" +
                                               "ot/jimple/paddle/BDDContextCallGraphBuilder.jedd:38,45-53"),
                                              edgesIn.get());
        final jedd.internal.RelationContainer newOut =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "hotak/soot-resolving2/src/soot/jimple/paddle/BDDContextCallG" +
                                               "raphBuilder.jedd:39,45-51"),
        ...
        final jedd.internal.RelationContainer methods =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "otak/soot-resolving2/src/soot/jimple/paddle/BDDContextCallGr" +
                                               "aphBuilder.jedd:42,23-30"),
                                              methodsIn.get());
        Rsrcc_srcm_stmt_kind_tgtc_tgtm edges =
          cicg.edgesOutOf(new Rctxt_methodBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { method.v(), ctxt.v() },
                                                                                  ...
                                                                                  ("new soot.jimple.paddle.queue.Rctxt_methodBDD(...) at /home/o" +
                                                                                   "lhotak/soot-resolving2/src/soot/jimple/paddle/BDDContextCall" +
                                                                                   "GraphBuilder.jedd:45,12-15"),
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), stmt.v(), kind.v(), srcm.v(), srcc.v(), tgtc.v() },
                                                    ...
                                                    ("out.add(newOut) at /home/olhotak/soot-resolving2/src/soot/ji" +
                                                     "mple/paddle/BDDContextCallGraphBuilder.jedd:49,8-11"),
                                                    newOut));
        m2c.eqUnion(methods);
