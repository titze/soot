    ...
    public boolean update() {
        final jedd.internal.RelationContainer newOut =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "t = in.get(); at /home/olhotak/soot-ref/src/soot/jimple/padd" +
                                               "le/BDDInsensitiveStaticContextManager.jedd:34,45-51"),
                                              in.get());
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), tgtc.v(), srcm.v(), tgtm.v(), kind.v(), stmt.v() },
                                                    ...
                                                    ("out.add(newOut) at /home/olhotak/soot-ref/src/soot/jimple/pa" +
                                                     "ddle/BDDInsensitiveStaticContextManager.jedd:35,8-11"),
                                                    newOut));
